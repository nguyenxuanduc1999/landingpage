...
export const About: React.FC = () => {
  return (
    <section id="about" className="w-full px-4 md:px-6 relative z-20 -mt-32 pt-24 pb-4 bg-gradient-to-b from-transparent via-black/90 to-transparent backdrop-blur-xl [-webkit-mask-image:linear-gradient(to_bottom,transparent,black_15%,black_calc(100%-16px),transparent)] [mask-image:linear-gradient(to_bottom,transparent,black_15%,black_calc(100%-16px),transparent)]">
